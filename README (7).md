...
**Lenguaje:** Python 3.10 o superior (el proyecto usa type hints como `tuple[int, float]`, que requieren Python moderno).
...
**Dependencias externas:** ninguna. El proyecto solo usa la biblioteca estándar de Python (`unittest` para las pruebas), así que no hace falta instalar nada con `pip` para correrlo.
